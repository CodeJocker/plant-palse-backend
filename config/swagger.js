...
const options = {
  definition: {
    ...
    tags: [
      ...
      {
        name: 'AI - DL Integration',
        description: 'Deep Learning model integration endpoints'
      },
      {
        name: 'AI - Specialized',
        description: 'Specialized diagnosis and treatment endpoints'
      },
      {
        name: 'AI - Data',
      ...
      {
        name: 'Marketplace',
        description: 'Plant disease medicine marketplace endpoints'
      }
    ],
    components: {
      schemas: {
        ...
        DiagnosisRequest: {
          ...
          properties: {
            symptoms: {
              ...
              example: 'Brown spots with yellow halos on leaves, leaves turning yellow'
            },
            plantType: {
              type: 'string',
              description: 'Type of plant affected',
